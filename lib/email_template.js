...
// export const bcc = 'Rabbi Ari Lev Fornari <rabbi@kol-tzedek.org>'
...
The yahrzeit for your ${relationship}, ${english_name_deceased}, is coming up on ${yahr_in_selected_cal}. They passed away on the Gregorian date ${g_date_of_passing} ${sunset_preposition} sunset, which corresponded to the Hebrew date of ${hd_date_of_passing}.
...
As a community, we are memory keepers. On this yahrzeit, we invite you to sponsor oneg or make a donation to our memorial fund in their memory (https://www.kol-tzedek.org/donate.html).
...
<p>Dear ${first_name},</p>
<p><strong>The yahrzeit for your ${relationship}, ${english_name_deceased}, is coming up on ${yahr_in_selected_cal}.</strong> They passed away on the Gregorian date ${g_date_of_passing} ${sunset_preposition} sunset, which corresponded to the Hebrew date of ${hd_date_of_passing}.</p>
...
<p>As a community, we are memory keepers. <strong>On this yahrzeit, we invite you to sponsor oneg or <a href="https://www.kol-tzedek.org/donate.html">make a donation to our memorial fund</a> in their memory.</strong></p>
<p>May their memory be a blessing in your life.</p>
<p>L&rsquo;Shalom,<br>
Nadav Carmel, <em>Operations Manager</em><br>
