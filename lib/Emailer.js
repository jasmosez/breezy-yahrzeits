...
import {from, bcc, getSubject, getTextBody, getHtmlBody} from './sample_email_template.js'
...
export class Emailer {
  ...
  async sendEmail(form) {
    const details = {
      ...
      relationship: form.response[config.formConstants.relationshipField],
      english_name_deceased: form.response[config.formConstants.englishNameDeceasedField],
